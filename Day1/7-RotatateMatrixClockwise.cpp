...
{
    //Going to solve this question by my own without taking any other person's help
    //Firstly writing the code to rotate the outer most layer and then I will generalize it with the help of dimensions of the diagonal.
    //Taking help from coding ninjas solutions because my approach will take time to implement and will implement the same appraoch again when I will do this.
